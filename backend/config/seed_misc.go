...
var miscSeeds = []seedScroll{
	...
	//  商城道具(WC)
	// ════════════════════════════════════════
	{Name: "神秘背包", Percentage: 10, Category: "神祕背包", Description: "神秘背包", ItemType: model.ItemTypePoints, TrackPriority: model.TrackPrioritySecondary},
	...
	{Name: "異界箱", Percentage: 10, Category: "全職業", Description: "全職業", ItemType: model.ItemTypeEquip, TrackPriority: model.TrackPriorityPrimary},
